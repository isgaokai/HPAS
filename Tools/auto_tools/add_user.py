...
class CreatePhone:
    def __init__(self):
        self.phone_start = ['134', '135', '136', '137', '138', '139', '147', '150', '151', '152',
                            '157', '158', '159', '165', '178', '182', '183', '187', '188', '198']

    def create(self):
        index = random.randint(0, 19)
        new_phone = self.phone_start[index]
        ...
        new_phone += str(a) + str(b) + str(c) + str(d) + str(e) + str(f) + str(g) + str(h)
...
class CreateEmail:
    def __init__(self):
        self.email_end = ['@qq.com', '@163.com', '@gmail.com', '@126.com', '@sina.com']

    def create(self):
        length = random.randint(5, 10)
        new_email = ''.join(
            random.sample(Tools.number_table + Tools.upper_alpha_table + Tools.lower_alpha_table, length))
        index = random.randint(0, 4)
        new_email += self.email_end[index]
        return new_email


class CreateNickname:
    def __init__(self):
        self.start_name = ["西本", "日高", "筱冢", "绿谷", "毛利", "月咏", "工藤", "汤川", "金木",
                           "加贺", "内海", "日暮", "夏目", "珍野", "道木", "铃原"]
        self.end_name = ["雪穗", "邦彦", "一成", "出久", "奈美江", "几斗", "新一", "三叶", "研", "唯",
                         "熏", "玲", "篱", "兰", "恭一郎", "修", "寒月", "贵志", "苦沙弥", "怜南", "奈绪"]

    def create(self):
        start_index = random.randint(0, 15)
        end_index = random.randint(0, 20)
        return self.start_name[start_index] + self.end_name[end_index]
...
class CreatePassword:
    def create(self):
        ...
        password = ''.join(
            random.sample(Tools.number_table + Tools.upper_alpha_table + Tools.lower_alpha_table + Tools.seq_table,
                          length))
        return password
...
class CreateCode:
    def create(self):
        return ''.join(
            random.sample(Tools.number_table + Tools.upper_alpha_table + Tools.lower_alpha_table,
                          12))


class CreateIP:
    def create(self):
        ips = ['58.14.0.0', '58.16.0.0', '58.24.0.0', '58.30.0.0', '58.32.0.0', '58.66.0.0', '58.68.128.0',
               '58.82.0.0',
               ...
               '117.72.0.0',
               '117.74.64.0', '117.74.128.0', '117.75.0.0', '117.76.0.0', '117.80.0.0', '117.100.0.0',
               '117.103.16.0',
               '117.103.128.0', '117.106.0.0', '117.112.0.0', '117.120.64.0', '117.120.128.0', '117.121.0.0',
               '117.121.128.0',
               '117.121.192.0', '117.122.128.0', '117.124.0.0', '117.128.0.0', '118.24.0.0', '118.64.0.0',
               '118.66.0.0',
               '118.67.112.0', '118.72.0.0', '118.80.0.0', '118.84.0.0', '118.88.32.0', '118.88.64.0',
               '118.88.128.0', '118.89.0.0',
               '118.91.240.0', '118.102.16.0', '118.112.0.0', '118.120.0.0', '118.124.0.0', '118.126.0.0',
               '118.132.0.0',
               '118.144.0.0', '118.178.0.0', '118.180.0.0', '118.184.0.0', '118.192.0.0', '118.212.0.0',
               '118.224.0.0',
               '118.228.0.0', '118.230.0.0', '118.239.0.0', '118.242.0.0', '118.244.0.0', '118.248.0.0',
               '119.0.0.0', '119.2.0.0',
               ...
               '119.27.192.0',
               '119.28.0.0', '119.30.48.0', '119.31.192.0', '119.32.0.0', '119.40.0.0', '119.40.64.0',
               '119.40.128.0', '119.41.0.0',
               ...
               '121.32.0.0',
               '121.40.0.0', '121.46.0.0', '121.48.0.0', '121.51.0.0', '121.52.160.0', '121.52.208.0',
               '121.52.224.0', '121.55.0.0',
               ...
               '122.49.0.0',
               '122.51.0.0', '122.64.0.0', '122.96.0.0', '122.102.0.0', '122.102.64.0', '122.112.0.0',
               '122.119.0.0', '122.136.0.0',
               '122.144.128.0', '122.152.192.0', '122.156.0.0', '122.192.0.0', '122.198.0.0', '122.200.64.0',
               '122.204.0.0',
               '122.224.0.0', '122.240.0.0', '122.248.48.0', '123.0.128.0', '123.4.0.0', '123.8.0.0',
               '123.49.128.0', '123.52.0.0',
               ...
               '123.138.0.0',
               '123.144.0.0', '123.160.0.0', '123.176.80.0', '123.177.0.0', '123.178.0.0', '123.180.0.0',
               '123.184.0.0',
               ...
               '124.68.0.0',
               '124.72.0.0', '124.88.0.0', '124.108.8.0', '124.108.40.0', '124.112.0.0', '124.126.0.0',
               '124.128.0.0',
               ...
               '125.254.128.0',
               '134.196.0.0', '159.226.0.0', '161.207.0.0', '162.105.0.0', '166.111.0.0', '167.139.0.0',
               '168.160.0.0',
               '169.211.1.0', '192.83.122.0', '192.83.169.0', '192.124.154.0', '192.188.170.0', '198.17.7.0',
               '202.0.110.0',
               '202.0.176.0', '202.4.128.0', '202.4.252.0', '202.8.128.0', '202.10.64.0', '202.14.88.0',
               '202.14.235.0',
               ...
               '202.60.112.0',
               '202.63.248.0', '202.69.4.0', '202.69.16.0', '202.70.0.0', '202.74.8.0', '202.75.208.0',
               '202.85.208.0',
               '202.90.0.0', '202.90.224.0', '202.90.252.0', '202.91.0.0', '202.91.128.0', '202.91.176.0',
               '202.91.224.0',
               '202.92.0.0', '202.92.252.0', '202.93.0.0', '202.93.252.0', '202.95.0.0', '202.95.252.0',
               '202.96.0.0',
               ...
               '202.189.80.0',
               '202.192.0.0', '203.18.50.0', '203.79.0.0', '203.80.144.0', '203.81.16.0', '203.83.56.0',
               '203.86.0.0',
               '203.86.64.0', '203.88.32.0', '203.88.192.0', '203.89.0.0', '203.90.0.0', '203.90.128.0',
               '203.90.192.0',
               '203.91.32.0', '203.91.96.0', '203.91.120.0', '203.92.0.0', '203.92.160.0', '203.93.0.0',
               '203.94.0.0', '203.95.0.0',
               ...
               '210.15.0.0',
               '210.15.128.0', '210.16.128.0', '210.21.0.0', '210.22.0.0', '210.23.32.0', '210.25.0.0',
               '210.26.0.0', '210.28.0.0',
               ...
               '218.96.0.0',
               '218.104.0.0', '218.108.0.0', '218.185.192.0', '218.192.0.0', '218.240.0.0', '218.249.0.0',
               '219.72.0.0',
               '219.82.0.0', '219.128.0.0', '219.216.0.0', '219.224.0.0', '219.242.0.0', '219.244.0.0',
               '220.101.192.0',
               ...
               '221.12.0.0',
               '221.12.128.0', '221.13.0.0', '221.14.0.0', '221.122.0.0', '221.129.0.0', '221.130.0.0',
               '221.133.224.0',
               '221.136.0.0', '221.172.0.0', '221.176.0.0', '221.192.0.0', '221.196.0.0', '221.198.0.0',
               '221.199.0.0',
               '221.199.128.0', '221.199.192.0', '221.199.224.0', '221.200.0.0', '221.208.0.0', '221.224.0.0',
               '222.16.0.0',
               '222.32.0.0', '222.64.0.0', '222.125.0.0', '222.126.128.0', '222.128.0.0', '222.160.0.0',
               '222.168.0.0',
...
Phone_ = CreatePhone()
Email_ = CreateEmail()
NickName_ = CreateNickname()
Password_ = CreatePassword()
Code_ = CreateCode()
IP_ = CreateIP()

# 获得当前脚本存放的父目录的绝对路径
project_path = os.path.abspath('.')
# 进行路径拼接 add_user_pool.txt路径
project_path = os.path.join(project_path, 'Pool', 'add_user_pool.txt')
#
for _ in range(500):
    nickname = NickName_.create()
    phone = Phone_.create()
    email = Email_.create()
    pass_word = Password_.create()
    # 对密码进行加盐
    password_salt, password = Tools.password_encryption(pass_word)
    cdk = Code_.create()
    registered_ip_address = IP_.create()
    try:
        with transaction.atomic():
            Code.objects.create(cdk=cdk, state=False)
            NormalUser.objects.create(nickname=nickname, password=password, phone=phone, email=email,
                                      registered_ip_address=registered_ip_address, used_code=cdk,
                                      password_salt=password_salt)
        with open(project_path,mode='a+',encoding='utf8') as write_user:
            write_user.write(str(nickname)+' '+str(phone)+' '+str(email)+' '+str(registered_ip_address)+' '+str(pass_word))
            write_user.write('\n')
        print('{}成功 {}, {}'.format(nickname,phone,email))
    except:
        print('{}出错 {}, {}'.format(nickname,phone,email))
